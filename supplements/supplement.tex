...
initialization (Sec.~\ref{sm:robust}). All quantities use the definitions, estimators, and
...
the identity increasingly governs the multi-step improvement as well. The tightening reported in the
